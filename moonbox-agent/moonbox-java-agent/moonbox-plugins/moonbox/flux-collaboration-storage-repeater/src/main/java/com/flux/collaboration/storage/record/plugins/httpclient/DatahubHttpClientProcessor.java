 ...
 */
package com.flux.collaboration.storage.record.plugins.httpclient;
 ...
 */
public class DatahubHttpClientProcessor extends DefaultInvocationProcessor {
    ...
    DatahubHttpClientProcessor(InvokeType type) {
        super(type);
    }
    ...
    public Identity assembleIdentity(BeforeEvent event) {
        ...
        try {
            ...
            if (uri instanceof String) {
                return new Identity(InvokeType.DATAHUB_HTTP_CLIENT.name(), (String) uri, "", null);
            }
//            urlStr = (String) MethodUtils.invokeMethod(uri, true, "toString");
            ...
            urlStr = HttpUtil.getPureUrL(MethodUtils.invokeMethod(uri, true, "getScheme"),
                    MethodUtils.invokeMethod(uri, true, "getHost")) + ":" + MethodUtils.invokeMethod(uri, true, "getPort") +
                            path;
        } catch (Exception e) {
            MoonboxLogUtils.error("apacheHttpClient-plugin assembleMockResponse error, event={}",
                    event.javaClassName + "|" + event.javaMethodName, e);
        }
        return new Identity(InvokeType.DATAHUB_HTTP_CLIENT.name(), urlStr, "", null);
    }
