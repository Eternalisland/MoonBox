...
public class HessianServiceRepeater extends AbstractRepeater {
    @Override
    ...
    public InvokeType getType() {
        return InvokeType.DATAHUB_HESSIAN_SERVICE;
    }

    @Override
    public String identity() {
        return InvokeType.DATAHUB_HESSIAN_SERVICE.getInvokeName() ;
    }
}
