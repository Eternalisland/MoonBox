...
public class DatahubHttpClientPlugin extends AbstractInvokePluginAdapter {
    ...
    protected InvocationProcessor getInvocationProcessor() {
        return new DatahubHttpClientProcessor(this.getType());
    }

    @Override
    public InvokeType getType() {
        return InvokeType.DATAHUB_HTTP_CLIENT;
    }

    @Override
    public String identity() {
        return InvokeType.DATAHUB_HTTP_CLIENT.getInvokeName();
    }
